...
ULONG UniversalClass::m_objNum = 0;
CRITICAL_SECTION UniversalClass::m_cs;
...
HRESULT _stdcall UniversalClass::QueryInterface(const IID &riid, void **ppvObject)
{
...
ULONG _stdcall UniversalClass::AddRef()
{
	m_Ref++;
	return m_Ref;
}

ULONG _stdcall UniversalClass::Release()
{
	m_Ref--;
	if (0 == m_Ref)
	{
...
LPCTSTR _stdcall UniversalClass::HelloWorld()
{
	return g_SoaringLoong;
}

int UniversalClass::Init()
{
	m_objNum = 0;
