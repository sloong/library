...
namespace SoaringLoong
{
	...
	class SLUNIVERSAL_API CLogSystem
	{
	public:
	...
	class SLUNIVERSAL_API CException
	{
	public:
		CException();
		~CException();
	...
	class SLUNIVERSAL_API CSize : public tagSIZE
	{
	public:
	...
	class SLUNIVERSAL_API CPoint : public tagPOINT
	{
	public:
		// Constructors
	...
	class SLUNIVERSAL_API CRect : public tagRECT
	{
		// Constructors
	public:
	...
	SLUNIVERSAL_API extern CLogSystem g_oLog;
}
