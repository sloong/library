...
#define VERSION_FILEVERSION					L"2.0.0.77"
#define VERSION_BUILDTIME					L"2014/10/29"
#ifdef _DEBUG
#define VERSION_PRODUCTVERSION 				L"Ver.2.0 for Debug"
...
#else
#define VERSION_PRODUCTVERSION 				L"Ver.2.0")
...
#define	VERSION_LEGALCOPYRIGHT				L"Copyright (C) 2014-2015 Sloong, Inc."
