...
CString CSloongConnection::GetConnectionString() const
{
	return (TCHAR *)(m_pConn->GetConnectionString());
}

void CSloongConnection::SetConnectionString(CString strConn)
{
	m_pConn->PutConnectionString(_bstr_t(strConn));
}

void CSloongConnection::SetConnectionString(char *charConn)
{
...
CString CSloongConnection::GetErrorMessage() const
{
